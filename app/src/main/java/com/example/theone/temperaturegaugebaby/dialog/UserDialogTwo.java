...
public class UserDialogTwo extends Dialog implements
	...
	public UserDialogTwo(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		this.context = context;
	}

	public UserDialogTwo(Context context, OnToLoginClickListener listener,
			int theme) {
		super(context, theme);
		this.context = context;
...
//		this.setContentView(R.layout.tologin);
		this.setContentView(R.layout.pop_newuser);
		init();
	}
