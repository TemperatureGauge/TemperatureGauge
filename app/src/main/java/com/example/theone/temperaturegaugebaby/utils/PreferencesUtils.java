...
public class PreferencesUtils {
	...
	public static String PREFERENCE_NAME = "zhinenglunhua";

	public static String REFRESHCOOKIEDATE = "refreshCookieDate"; // 刷新cookie的时间
	public static String TOKEN = "token"; // 保存token
	public static String ISFIRSTLINK = "isFirstLink"; // 是否是第一次连接硬件
